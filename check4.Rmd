...
mvals=seq(0,.6,,31)
k5   = rbind(k5ang0  ,read.csv("output5.csv"))
k20  = rbind(k20ang0 ,read.csv("output20.csv"))
k50  = rbind(k50ang0 ,read.csv("output50.csv"))
k100 = rbind(k100ang0,read.csv("output100.csv"))
